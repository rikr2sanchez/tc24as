...
class SiteController extends Controller
{
    ...
    public function actionPlaywait() {
        return "<Response>
...
<Play> http://com.twilio.sounds.music.s3.amazonaws.com/oldDog_-_endless_goodbye_%28instr.%29.mp3 </Play>
<Play> http://com.twilio.sounds.music.s3.amazonaws.com/Mellotroniac_-_Flight_Of_Young_Hearts_Flute.mp3 </Play>
...
// Where to make a voice call (your cell phone?)
        ...
        $client->account->calls->create(
            ...
            $twilio_number,
            array(
                "url" => "assets/about_to_connect.xml"
            )
        );
